...
<>
{
 ...
 <ScaleLoader color="#adff2f" cssOverride={{}} height={200} 
      loading margin={4} radius={15} speedMultiplier={2} width={15} /> <h1 className='loading000'>تم ارسال الطلب بنجاح</h1><h1 className='loading000'>برجاء التواصل معنا لاكمال الطلب</h1> </div>
      : 
